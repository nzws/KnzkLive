...
function donation_url($user_id, $allow_nonech = true)
{
    ...
    if (!empty($u["misc"]["donation_alerts_name"])) {
        $url = "https://www.donationalerts.com/r/" . $u["misc"]["donation_alerts_name"];
    } elseif (!empty($u["misc"]["streamlabs_token"])) {
        $url = "https://streamlabs.com/" . $u["misc"]["streamlabs_name"];
    } elseif (!empty($u["misc"]["donate_url"]) && $allow_nonech) {
        $url = $u["misc"]["donate_url"];
    } else {
        return null;
    }
